...
pub const Video = struct {
    ...
    pub fn init(boot_info: *const FirmwareInterface) !Video {
    ...
    inline fn drawCharacter(self: *Video, c: u8, x: u32, y: u32) void {
    ...
    inline fn setPixel(self: *Video, px: u32, py: u32, color: u32) void {
    ...
    pub fn printf(self: *Video, comptime fmt: []const u8, args: anytype) void {
